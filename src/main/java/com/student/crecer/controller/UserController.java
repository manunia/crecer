...
public class UserController {
    ...
    public String updateProfile(
        ...
        userServise.updateProfile(user,password);
    ...
    public String subscribe(
        ...
        userServise.subscribe(currentUser, user);

        return "redirect:/user-articles/" + user.getId();
    }
    ...
    public String unsubscribe(
        ...
        userServise.unsubscribe(currentUser, user);
